...
// and onboarding.html. Five automated steps orbit the frozen ruler at the centre;
...
const STEPS = [
  ...
  { deg: 126, n: 4, t: 'EVALUATE',    d: ['run all 30 cases', 'through the ruler'],        anchor: 'end',    lx: -18, ty: 17,  dy: 35 },
...
const evalP = pt(126);                       // EVALUATE node — links to the ruler
...
<svg viewBox="0 0 760 520" style="width:100%;height:auto;max-width:760px;display:block;margin:0 auto"
     ...
     aria-label="The autoresearch loop: read, hypothesize, implement, evaluate, log — orbiting a frozen ruler, supervised by a human.">
  <defs>
  ...
  <text x="370" y="247" text-anchor="middle" font-size="13" letter-spacing="0.6" font-weight="600" fill="var(--ink)">FROZEN RULER</text>
