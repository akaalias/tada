    ...
    private func getToolSchema(for typeName: String) -> [String: Any] {
        ...
        case "ActionSchema":
            return [
                ...
                "description": "Generate a UI schema for user interaction. IMPORTANT: field type must be exactly one of: text, number, multiSelect, singleSelect, yesNo, date, textarea, drawing, slider, rangeSlider, countSelector, itemTable, orderedList, hierarchicalList, brainstorm. For yes/no questions use yesNo not radio.",
                "input_schema": [
                    "type": "object",
                    "properties": [
